...
export default function Header() {
    ...
    return (
        ...
        >
            ...
            {/* NAVIGATION */}
            <div
                className={`mx-auto flex max-w-7xl items-center transition-all duration-300 ${isSticky ? "py-10 px-6" : "py-5 px-8"
                    }`}
            >
                {/* Sticky Logo */}
                <div
                ...
                <nav className="flex flex-wrap items-center gap-8">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        {dropdownOpen && (
                            <div className="absolute left-0 top-full mt-2 min-w-[220px] rounded bg-white py-2 shadow-lg">
                ...
                <div className="ml-auto flex items-center">
                    {isSticky ? (
                        <div className="flex items-center">
                            <div
                                className={`overflow-hidden transition-all duration-300 ${searchOpen ? "w-56 opacity-100" : "w-0 opacity-0"
                                    }`}
                            >
