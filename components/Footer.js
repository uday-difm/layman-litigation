...
export default function Footer({ config = null, categories = [], navigation = {} }) {
  ...
  let categoriesCol1 = fallbackCategoriesCol1;
  let categoriesCol2 = fallbackCategoriesCol2;
  ...
  const copyrightText =
    config?.copyright ||
    "Copyright © 2026 Do It For Me LLC. For the People, By the Lawyers.";
    ...
    <footer className="bg-[#212121] text-gray-300">
      ...
      <div className="mx-auto max-w-7xl px-8 py-12">
        {hasValidConfig ? (
                ...
                return (
                  <div key={index}>
                    ...
                    <ul className="space-y-2 text-sm text-gray-400">
                      {col.address && <li>Address: {col.address}</li>}
                      {col.phone && (
                        <li>
                          Phone:{" "}
                          <a
          ...
          /* Fallback styled layout (Hybrid with dynamic categories) */
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            {/* Categories */}
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                © 2026{" "}
                <span className="italic text-[#d9b04f]">Layman Litigation</span>{" "}
