    ...
    <section className="py-16 bg-slate-50 text-slate-800 border-t border-b">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl font-extrabold tracking-tight text-[#1b1b1b]">Our Services</h2>
...
function TeamSection({ content }) {
  ...
  return (
    <section className="py-16 bg-white text-slate-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl font-extrabold tracking-tight text-[#1b1b1b]">Meet Our Team</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {items.map((member) => (
            <div key={member.id} className="text-center group">
              ...
              <p className="text-xs text-[#d9b04f] font-semibold mb-1">{member.role}</p>
    ...
    <section className="py-16 bg-[#1b1b1b] text-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-400 mt-2 text-sm">Hear directly what our global partners say about us.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((item) => (
            <div key={item.id} className="bg-neutral-900/60 p-6 rounded-xl border border-neutral-800 backdrop-blur-sm flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-350 text-xs italic leading-relaxed mb-6">"{item.content}"</p>
              </div>
    ...
    <section className="py-16 bg-white text-slate-800">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold tracking-tight text-[#1b1b1b]">FAQ</h2>
  ...
  return (
    <section className="py-12 bg-gradient-to-r from-[#1b1b1b] to-neutral-800 text-white border-t border-neutral-700">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        {content?.subtitle && <p className="text-sm text-slate-300 max-w-2xl mx-auto mb-6">{content.subtitle}</p>}
